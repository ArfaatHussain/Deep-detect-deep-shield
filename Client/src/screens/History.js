...
export default function History() {
    ...
    const renderItem = ({ item }) => {
        const hasDetectionResult =
            ...
            item.detectionResult.resultImage; // optional: ensure resultImage exists
        ...
        return (
            <View style={styles.historyCard}>
                ...
                <Text style={{ marginTop: 10, color: '#969191ff' }}>
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                ...
                ListEmptyComponent={() => <Text style={{ color: '#a4a2a2ff', textAlign: 'center' }} >No history yet.</Text>}
